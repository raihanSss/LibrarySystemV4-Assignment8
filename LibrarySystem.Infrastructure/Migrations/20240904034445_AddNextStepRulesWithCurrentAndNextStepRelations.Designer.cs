...
namespace LibrarySystem.Infrastructure.Migrations
{
    ...
    [Migration("20240904034445_AddNextStepRulesWithCurrentAndNextStepRelations")]
    partial class AddNextStepRulesWithCurrentAndNextStepRelations
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("LibrarySystem.Domain.Models.NextStepRules", b =>
                {
                    ...
                    NpgsqlPropertyBuilderExtensions.UseIdentityByDefaultColumn(b.Property<int>("Id_rule"));

                    b.Property<int>("Id_currentstep")
                        .HasColumnType("integer")
                        .HasColumnName("id_currentstep");

                    b.Property<int>("Id_nextstep")
                        .HasColumnType("integer")
                    ...
                    b.HasIndex("Id_currentstep");

                    b.HasIndex("Id_nextstep");
